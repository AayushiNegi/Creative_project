$(document).ready(function () {
    ...
    if (
        ...
        (f = $(".sidebar-scrollbar")),
        f.length != 0 &&
            f.slimScroll({ opacity: 0, height: "100%", color: "#808080", size: "5px", touchScrollStep: 50 }).mouseover(function () {
    ...
    if (((n = $("#body")), $(window).width() >= 768)) {
        ...
        $("#sidebar-toggler").on("click", function () {
            (n.hasClass("ec-sidebar-fixed-offcanvas") || n.hasClass("ec-sidebar-static-offcanvas")) &&
                ($(this).addClass("sidebar-offcanvas-toggle").removeClass("sidebar-toggle"),
                window.isCollapsed === !1
                    ? (n.addClass("sidebar-collapse"), (window.isCollapsed = !0), (window.isMinified = !1))
            ...
            (n.hasClass("ec-sidebar-fixed") || n.hasClass("ec-sidebar-static")) &&
                ...
                window.isMinified === !1
                    ? (n.removeClass("sidebar-collapse sidebar-minified-out").addClass("sidebar-minified"), (window.isMinified = !0), (window.isCollapsed = !1))
                    : (n.removeClass("sidebar-minified"), n.addClass("sidebar-minified-out"), (window.isMinified = !1)));
        });
    }
    $(window).width() >= 768 &&
        $(window).width() < 992 &&
        (n.hasClass("ec-sidebar-fixed") || n.hasClass("ec-sidebar-static")) &&
        (n.removeClass("sidebar-collapse sidebar-minified-out").addClass("sidebar-minified"), (window.isMinified = !0));
    i = "right-sidebar-in";
    u = "right-sidebar-out";
    ...
    s.length != 0 && s.tooltip({ container: "body", template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>' });
    h = $('[data-toggle="popover"]');
    h.length != 0 && h.popover();
    c = $("#basic-data-table");
    c.length !== 0 && c.DataTable({ dom: '<"row justify-content-between top-information"lf>rt<"row justify-content-between bottom-information"ip><"clear">' });
    ...
    $.ajax({
        ...
        data: { google_url: w, google_font: b, google_version: "EKKA-HTML-TEMPLATE-AK" },
        success: function (n) {
            $("body").append(n);
        },
    });
