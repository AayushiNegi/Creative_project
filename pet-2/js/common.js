jQuery(document).ready(function() {
    ...
    jQuery("#nav li.level0.drop-menu").mouseover(function() {
        ...
        jQuery("#top-categories .slider-items").owlCarousel({
            ...
            itemsMobile: [320, 2],
            navigation: !0,
            navigationText: ['<img src="images/sn-2.jpg">', '<a class="flex-next"></a>'],
            slideSpeed: 500,
            pagination: !1
        }),
 ...
 jQuery("#brand-sliderr .slider-itemss").owlCarousel({
          autoplay : true,
          ...
          itemsMobile : [320,1],
          navigation : true,
         navigationText: ['<img src="images/banner_prev.png">', '<img src="images/banner_next.png">'],
          slideSpeed : 500,
          nav:true,
          pagination :true          
        }),
		...
		jQuery("#testimonialss .slider-itemsss").owlCarousel({
          autoplay : true,
	      items : 5, //10 items above 1000px browser width
	      ...
	      //navText:["<div class='nav-btn prev-slide'></div>","<div class='nav-btn next-slide'></div>"],
           navigationText : ['<img src="images/left-a.png">','<img src="images/right-a.png">'],
	      slideSpeed : 500,
	      pagination :false	

        }),

        jQuery("#testimonialsss .slider-itemssss").owlCarousel({
          autoplay : true,
    ...
    jQuery("#category-desc-slider .slider-items").owlCarousel({
       ...
       jQuery("#gallery_01 .slider-items").owlCarousel({
		    ...
		    /*  More Views Slider */
           jQuery(".categorie_slider").owlCarousel({
                autoplay: false,
